...
import com.bschandramohan.learn.springconnect.springbootsampleprojects.worldbankdata.aop.TimeIt
...
class WorldBankServiceImpl : WorldBankService {
    val logger: Logger = LoggerFactory.getLogger(WorldBankServiceImpl::class.java)
    ...
    override fun getGdp(countryCode: String): String {
        logger.info("Retrieving GDP for country=$countryCode")
